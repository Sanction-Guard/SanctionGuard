 ...
 */
const BlockListIndividualSchema = new mongoose.Schema({
    ...
    importId: {
        type: mongoose.Schema.Types.ObjectId,  // Reference to Import model
...
const BlockListIndividual = mongoose.model('BlockListIndividual', BlockListIndividualSchema);
